...
mongod --dbpath "G:\Dong\My Projects\visPlayer\data\log\mongod.log"
...
//  import commands
----------------------------------------------------------------------------------------
mongoimport --db visfuture-dev --collection tools --type json --file "G:\Dong\My Projects\visPlayer\data\tools.json" --jsonArray
